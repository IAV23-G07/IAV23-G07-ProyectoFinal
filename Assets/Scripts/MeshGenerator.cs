...
public static class MeshGenerator{
    ...
    public static void GenerateTerrainMeshChunk(Cell[,] mapaCells, Vector2 pos, GameObject basee, float heightPerBlock)
    {
    ...
    public static void DrawEdgesChunk(Cell[,] mapaCells, Vector2 pos, GameObject edges, float heightPerBlock)
    {
        int size = mapaCells.GetLength(0);
